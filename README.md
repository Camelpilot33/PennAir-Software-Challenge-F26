...
(Whole output video is in `part2/output_p2.mp4`)\
...
(Whole output video is in `part3/output_p3.mp4`)\
...
(Whole output video is in `part4/output_p4.mp4`)\
...
Giving a an output stream formatted as:
```JSON
data: [
...
(Whole output video is in `part6/output_p6.mp4`)\

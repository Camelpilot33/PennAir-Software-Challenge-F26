...
out = cv2.VideoWriter('./part4/output_p4.mp4', fourcc, fps, (frame_width, frame_height))
...
def process_image(input_img): # exact same as p1, but pulled out morph kernel to adjust for video resolution
    ...
    for contour in contours:
        ...
        cv2.drawContours(input_img, [contour_scaled], -1, (0, 0, 0), max(1, int(2 / PROCESS_SCALE)))
